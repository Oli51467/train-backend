<template>
    <ContentBase>
        ...
        <a-table :dataSource="trainSeats" :columns="columns" :pagination="pagination" @change="handleTableChange"
            :loading="loading">
        ...
        <a-modal v-model:visible="visible" title="座位" @ok="handleOk" ok-text="确认" cancel-text="取消">
            <a-form :model="trainSeat" :label-col="{ span: 4 }" :wrapper-col="{ span: 20 }">
                <a-form-item label="车次编号">
                    <TrainSelect v-model="trainSeat.trainCode"></TrainSelect>
                </a-form-item>
...
export default defineComponent({
    ...
    setup() {
        ...
        const handleQuery = (param) => {
            ...
            loading.value = true;
            axios.get("/business/admin/train-seat/getAll/", {
                params: {
                    page: param.page,
